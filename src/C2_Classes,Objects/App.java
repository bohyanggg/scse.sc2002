...
public class App {
    ...
    Student myStudent2 = new Student(11457,'F', 1.55,21,course2);

    Course course3 = new Course(105,2004,1,90);
    Student myStudent3 = new Student(11458,'F', 1.85,28,course3);	
...
//this is a comment for me to test out bash and git